...
public class MeetingGeometry {
    ...
    boolean computeEventRect(int currentJulianDay, int left, int top, int cellWidth, EventInfo meeting) {
    ...
    boolean eventIntersectsSelection(Rect selection) {
        return this.left < selection.right && this.right >= selection.left
