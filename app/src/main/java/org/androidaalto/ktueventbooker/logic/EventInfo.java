...
public class EventInfo {
    ...
    public EventInfo(UserInfo user, Time start, Time end, String title, int pincode) {
        this(null, user, start, end, title, pincode);
    }

    public EventInfo(Long id, UserInfo user, Time start, Time end, String title, int pincode) {
        this.id = id;
        this.user = user;
        this.start = start;
        this.end = end;
    ...
    public String toString() {
        return "EventInfo [id=" + id + ", start=" + start.format3339(false) + ", end="
