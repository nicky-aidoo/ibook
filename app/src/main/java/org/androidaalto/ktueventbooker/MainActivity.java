...
import org.androidaalto.ktueventbooker.model.db.DataBaseHelper;
import org.androidaalto.ktueventbooker.model.db.UserDb;
import org.androidaalto.ktueventbooker.view.WeekView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (UserDb.get(DEFAULT_ADMIN_EMAIL) == null) {
          //  User admin = new User(null, "bookingroom_admin", DEFAULT_ADMIN_EMAIL, "012345", -1,
                    User admin = new User(null, "admin", DEFAULT_ADMIN_EMAIL, "1234", -1,
                    true);
            UserDb.store(admin);
        }
    }
